...
var circleOffset = new Position(0, -4);
var arrowsOffset = new Position(0, 0);

var arrowsLowBounds = new Position(2, -4);
var arrowsUpBounds = new Position(2, 152);
var circleLowBounds = new Position(-6, -6);
var circleUpBounds = new Position(148, 148);
...
function arrowsMoved(pos, element)
{
  ...
  currentColor.SetHSV((148 - pos.Y)*359.99/148, currentColor.Saturation(), currentColor.Value());
  colorChanged("arrows");
}
...
function circleMoved(pos, element)
{
  ...
  currentColor.SetHSV(currentColor.Hue(), 1-pos.Y/148.0, pos.X/148.0);
  colorChanged("circle");
}
...
function colorChanged(source)
{
 ...
 // document.getElementById("valueBox").value = str;
  ...
  if(source == "box")
  {
    ...
    el.style.top = (148 - currentColor.Hue()*1/359.99 - arrowsOffset.Y) + 'px';
    var pos = new Position(currentColor.Value()*148, (1-currentColor.Saturation())*148);
    pos = correctOffset(pos, circleOffset, true);
    pos.Apply("circle");
    endMovement();
  }
