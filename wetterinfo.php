...
function wetterinfo_config() {
	...
	<div class="wi-picker-quick-static">
		<div class="wi-picker-color-container">
			<div class="wi-picker-quick" id="quickColor"
			">
		</div>
		<div class="wi-picker-static" id="staticColor"
		">
	</div>
	</div>
	<br/>
	<div class="wi-picker-input">
		...
		<div> R
			<input maxlength="3" type="text" id="redBox" onchange="redBoxChanged();"/>
		</div>
		<div> G
			<input maxlength="3" type="text" id="greenBox" onchange="greenBoxChanged();"/>
		</div>
		<div> B
			<input maxlength="3" type="text" id="blueBox" onchange="blueBoxChanged();"/>
		</div>
		<div style="width:72px"> #
			<input style="width:50px" maxlength="7" type="text" id="hexBox" onchange="hexBoxChanged();"/>
		</div>
	</div>
	...
	<div id="wetterinfo-plugin-admin" class="wi-admin">
		...
		<p>Mit unserem Wordpress-Plugin können Sie spielend leicht das Wetter für ihre Stadt in ihrem Blog anzeigen lasssen.<br/>
			Wählen Sie die gewünschte Stadt aus, übernehmen sie das Design ihres Blogs oder konfigurieren Sie die Farben individuell.
		</p>
		<div class="wi-city">
...
class wetterinfoGadget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			...
			<a href="plugins.php?page=wetterinfo-config">hier</a> vorgenommen werden.
		</p>
